...
namespace Dcat\Admin {
     ...
     * @property Grid\Column|Collection sh
     ...
     * @method Grid\Column|Collection sh(string $label = null)
     ...
     * @property Show\Field|Collection sh
     ...
     * @method Show\Field|Collection sh(string $label = null)
